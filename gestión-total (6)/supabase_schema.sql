-- SCHEMA SUPABASE PARA GESTIÓN TOTAL
...
-- Desactivar o habilitar RLS permitiendo acceso a usuarios autorizados con tu anon key
...
-- Políticas permisivas para desarrollo/producción
